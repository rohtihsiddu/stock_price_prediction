...
define('vs/basic-languages/python/python', ['require', 'require'], (require) => {
  var moduleExports = (() => {
    ...
    var u = Object.getPrototypeOf, f = Object.prototype.hasOwnProperty;
    var b =
        (e => typeof require != 'undefined' ? require :
             typeof Proxy != 'undefined'    ? new Proxy(e, {
    ...
    var k = {
      ...
      folding: {
        ...
        $ = {
          ...
          tokenizer: {
            root: [
              {include: '@whitespace'}, {include: '@numbers'},
              {include: '@strings'}, [/[,:;]/, 'delimiter'],
              [/[{}\[\]()]/, '@brackets'], [/@[a-zA-Z_]\w*/, 'tag'],
              [
                /[a-zA-Z_]\w*/,
